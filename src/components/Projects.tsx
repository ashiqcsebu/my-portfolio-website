...
const Projects = () => {
  ...
  const filters = [
    { id: 'all', label: 'All Projects', count: projects.length },
        { id: 'shopify', label: 'Shopify', count: projects.filter(p => p.category === 'shopify').length },
...
Successfully delivered 53+ Shopify projects! Here’s a curated showcase of my best work—innovative, impactful and client-approved.          </p>
        </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {featuredProjects.map((project) => (
                <div key={project.id} className="group h-full">
                  <div className="glass-card p-6 hover:scale-105 transition-all duration-300 border border-primary/20 hover:border-primary/40 flex flex-col h-full">
                    ...
                    <div className="space-y-4 flex-1 flex flex-col justify-between">
                      ...
                      <div className="flex space-x-3 pt-4">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex-1 bg-primary text-primary-foreground px-4 py-2 rounded-lg text-sm font-medium hover:bg-primary/90 flex items-center justify-center"
                        >
