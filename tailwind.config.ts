  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow": {
          "0%, 100%": { boxShadow: "0 0 5px hsl(var(--gold))" },
          "50%": {
            boxShadow:
              "0 0 20px hsl(var(--gold)), 0 0 30px hsl(var(--gold))",
          },
        },
        "tilt": {
      ...
      minHeight: {
        ...
        "screen-header-lg": "calc(100vh - 80px)",
        "screen-footer": "calc(100vh - 120px)",
      },
    },
  },
...
// //         "glow": {
// //           "0%, 100%": { boxShadow: "0 0 5px hsl(var(--gold))" },
// //           "50%": { boxShadow: "0 0 20px hsl(var(--gold)), 0 0 30px hsl(var(--gold))" },
// //         },
// //         "tilt": {
// //           "0%, 100%": { transform: "rotate(0deg)" },
// //           "25%": { transform: "rotate(1deg)" },
